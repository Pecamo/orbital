...
var BlueFireAnimation = /** @class */ (function () {
    function BlueFireAnimation(rotation) {
    ...
    BlueFireAnimation.prototype.swap = function (color) {
        return new color_1.Color(color.b, color.g, color.r);
    };
    BlueFireAnimation.prototype.animate = function (t, display, options) {
        var _a;
        ...
        for (var n = 1; n < NB_LED_1.NB_LED / 2; n++) {
            ...
            var color = this.swap(utils_1.temperatureToRgb(temp));
            if (!this.rotation) {
        ...
        if (!this.rotation) {
            display.drawDot(utils_1.normalize(NB_LED_1.NB_LED / 2 + topLedNb), this.swap(utils_1.temperatureToRgb(this.temperatures[0])));
            display.drawDot(utils_1.normalize(NB_LED_1.NB_LED / 2 + topLedNb - 1), this.swap(utils_1.temperatureToRgb(this.temperatures[NB_LED_1.NB_LED])));
        }
        else {
            display.drawDot(utils_1.normalize(t + NB_LED_1.NB_LED / 2 + topLedNb), this.swap(utils_1.temperatureToRgb(this.temperatures[0])));
            display.drawDot(utils_1.normalize(t + topLedNb), this.swap(utils_1.temperatureToRgb(this.temperatures[NB_LED_1.NB_LED])));
            var colorFront = this.swap(utils_1.temperatureToRgb(this.temperatures[0] - 500));
    ...
    return BlueFireAnimation;
}());
exports.default = BlueFireAnimation;
